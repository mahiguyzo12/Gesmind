      ...
      <div className="relative z-10 w-full max-w-md my-8">
        ...
        <div className={`bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 ${setupMode === 'CREATE_FORM' ? 'max-w-2xl mx-auto' : ''}`}>
            ...
            {currentView === 'STORE_LOGIN' && (
                <div className="p-5 md:p-6 bg-white/90 backdrop-blur-xl">
                    <div className="text-center mb-4">
                        <h2 className="text-lg font-bold text-slate-800 tracking-tight">{t('login_button')}</h2>
                    </div>

                    <form onSubmit={handleStoreLogin} className="space-y-3 animate-fade-in">
                        <div className="space-y-0.5">
                            <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider ml-1">{t('username')}</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <UserIcon className="h-3.5 w-3.5 text-slate-400 group-focus-within:text-indigo-500 transition-colors" />
                                </div>
                                <input 
                                    type="text" 
                                    required 
                                    ...
                                    className="block w-full pl-8 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 text-xs font-medium" 
                        ...
                        <div className="space-y-0.5">
                            ...
                            <div className="relative group">
                                ...
                                <input 
                                    ...
                                    className="block w-full pl-8 pr-9 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 text-xs font-medium tracking-widest" 
                                    placeholder="••••"
                                />
                                <button 
                                    type="button" 
                        ...
                        <button 
                            type="submit" 
                            disabled={isLoading}
                            className="w-full flex justify-center items-center py-2.5 px-4 border border-transparent rounded-xl shadow-lg shadow-indigo-500/30 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="mt-4">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-white text-slate-400 font-medium uppercase text-[9px] tracking-wider">{t('or')}</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-3 grid grid-cols-1 gap-2">
                            <button 
                                ...
                                className="w-full inline-flex justify-center items-center py-2 px-4 border border-slate-200 rounded-xl shadow-sm bg-white text-xs font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200"
                            >
                                <PlusCircle className="w-3.5 h-3.5 mr-2 text-indigo-500"/>
                                {t('join_with_id')}
                            </button>
                        </div>
                    </div>
