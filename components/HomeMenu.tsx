  ...
  const allMenuItems = [
    {
      ...
      description: t('menu_dashboard_desc'),
    ...
    },
    {
      ...
      description: t('menu_inventory_desc'),
      icon: Package,
      requiredPerm: 'inventory.view',
    },
    {
      id: ViewState.COMMERCIAL,
      label: t('menu_commercial'),
      description: t('menu_commercial_desc'),
      icon: ShoppingCart,
    ...
    },
    {
      ...
      description: t('menu_expenses_desc'),
      icon: TrendingDown,
      requiredPerm: 'expenses.view',
    },
    {
      id: ViewState.TREASURY,
      label: t('menu_treasury'),
      description: t('menu_treasury_desc'),
      icon: Wallet,
    ...
    },
    {
      ...
      description: t('menu_customers_desc'),
      icon: Contact,
      requiredPerm: 'customers.view',
    },
    {
      id: ViewState.SUPPLIERS,
      label: t('menu_suppliers'),
      description: t('menu_suppliers_desc'),
      icon: Truck,
      requiredPerm: 'suppliers.view',
    },
    {
      id: ViewState.PERSONNEL,
      label: t('menu_personnel'),
      description: t('menu_personnel_desc'),
      icon: Briefcase,
    ...
    },
    {
      ...
      description: t('menu_settings_desc'),
      icon: Settings,
