...
export const GesmindLogo: React.FC<GesmindLogoProps> = ({
  className = 'w-32 h-32',
  withText = true,
}) => {
  return (
    <div className={`flex flex-col items-center justify-center ${className}`}>
      ...
      >
        ...
        <g
          transform="translate(190, 100) scale(0.8)"
          fill="white"
          opacity="0.9"
        >
        ...
        <g
          transform="translate(350, 300) scale(0.6)"
          fill="white"
          opacity="0.9"
        >
        ...
        <g transform="translate(210, 230) scale(1.5)">
          {/* Cart Body */}
          <path
            d="M10 10 L20 10 L30 40 L55 40 L60 20 L25 20"
            stroke="#0f172a"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
