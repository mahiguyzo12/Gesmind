...
export const analyzeStock = async (
  ...
  if (!API_KEY)
    throw new Error(
      'Clé API Gemini manquante. Vérifiez la configuration du build.'
    );
...
export const generateItemDetails = async (
  itemName: string
): Promise<GeneratedItemData> => {
...
export const generateStoreLogo = async (
  storeName: string,
  description?: string,
